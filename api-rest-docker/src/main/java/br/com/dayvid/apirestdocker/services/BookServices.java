...
public class BookServices {
    ...
    public BookVO findById(Long id) {
        ...
        vo.add(linkTo(methodOn(BookController.class).findById(id)).withSelfRel()); //link o methodo findbyid do controler diretamente ao obj vo criado com auto relacionamento (cria endereço para ele mesmo)
        return vo;
    }
    ...
    public BookVO create(BookVO book){
        ...
        vo.add(linkTo(methodOn(BookController.class).findById(vo.getKey())).withSelfRel()); //link o methodo findbyid do controler diretamente ao obj vo criado com auto relacionamento (cria endereço para ele mesmo)
        return vo;
    }
